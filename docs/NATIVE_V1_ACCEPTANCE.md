...
6. Finish with Stop/Exit, prove exact restore, and only then consider a longer display-off/headless/overnight run. Keep final outcomes scoped to the tested device, OS image, power source and security product.
